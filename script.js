...
let blogName = "Kalpar";
let authorName = "Oscar Daniel Sanchez Jaime";
...
[ "posts/2021-03-20-Flicksy.html" ], 
[ "posts/2021-03-15-Galeria-Pixelart-Marzo.html" ] ];
...
let headerHTML = '<ul> <li><a href="' + relativePath + '/index.html">Inicio</a></li>' + 
'<li><a href="' + relativePath + '/archive.html">Entradas</a></li>' +
'<li><a href="' + relativePath + '/about.html">Acerca</a></li> </li>' +
'<li><a href="' + relativePath + '/portfolio.html">Portafolio</a></ul>';

//Write the Footer HTML, which has information about the blog.
let footerHTML = "<hr><p>" + blogName + " esta escrito por <a href='" + authorLink + "'>" + authorName + "</a>, esta construido con <a href='https://zonelets.net/'>Zonelets</a>, y hospedado en <a href='https://neocities.org/'>Neocities!</a></p>";
...
if ( currentIndex > -1 ) {
  ...
  if (  postDateFormat.test ( postsArray[currentIndex][0].slice( 6,17 ) ) ) {
    ...
    let month = "";
    if ( monthSlice === "01") { month = "Enero";}
    else if ( monthSlice === "02") { month = "Febrero";}
    else if ( monthSlice === "03") { month = "Marzo";}
    else if ( monthSlice === "04") { month = "Abril";}
    else if ( monthSlice === "05") { month = "Mayo";}
    else if ( monthSlice === "06") { month = "Junio";}
    else if ( monthSlice === "07") { month = "Julio";}
    else if ( monthSlice === "08") { month = "Agosto";}
    else if ( monthSlice === "09") { month = "Septiembre";}
    else if ( monthSlice === "10") { month = "Octubre";}
    else if ( monthSlice === "11") { month = "Noviembre";}
    else if ( monthSlice === "12") { month = "Diciembre";}
...
let recentPostListHTML = "<h2>Post Recientes:</h2><ul>";
...
if ( postsArray.length < 2 ) {
  nextprevHTML = '<a href="' + relativePath + '/index.html">Inicio</a>';
} else if ( currentIndex === 0 ) {
  prevlink = postsArray[currentIndex + 1][0];
  nextprevHTML = '<a href="' + relativePath + '/index.html">Inicio</a> | <a href="'+ relativePath + '/' + prevlink +'">Post Anterior \u00BB</a>';
} else if ( currentIndex === postsArray.length - 1 ) {
  nextlink = postsArray[currentIndex - 1][0];
  nextprevHTML = '<a href="' + relativePath + '/' + nextlink +'">\u00AB Post Siguiente</a> | <a href="' + relativePath + '/index.html">Inicio</a>';
} else if ( 0 < currentIndex && currentIndex < postsArray.length - 1 ) {
  nextlink = postsArray[currentIndex - 1][0];
  prevlink = postsArray[currentIndex + 1][0];
  nextprevHTML = '<a href="' + relativePath + '/'+ nextlink +'">\u00AB Post Siguiente</a> | <a href="' + relativePath + '/index.html">Inicio</a> | <a href="' + relativePath + '/'+ prevlink +'">Post Anterior \u00BB</a>';
}
